...
namespace Engine
{
    ...
    public:
        ...
        glm::vec3 getRectFinalScale();
        UI::Anchor getAnchor();
        int getChildsSize();
        RectTransform* getChild(int index);
        RectTransform* getParent();
        glm::mat4 getPivotMatrix(UI::Anchor anchor, glm::mat4 anchorMatrix);
        glm::mat4 getAnchorMatrix(UI::Anchor anchor, glm::mat4 rectMatrix);
        ...
        void setRectPosition(glm::vec3 position);
        void setRectRotation(glm::vec3 rotation);
        void setRectScale(glm::vec3 scale);
